...
const TIERS = [
  {
    ...
    benefits: [
      ...
      "Largest logo placement among all sponsors",
      ...
      "Dedicated social media and newsletter spotlight",
      "Logo on printed and digital materials, including flyers, banners, and emails",
      "Logo on the physical “Thank You” banner",
  ...
  },
  {
    ...
    benefits: [
      ...
      "Logo on the main “Thank You” banner in school",
      "Recognition on year-round school sponsor banners along the fence",
      "Business name included in group Instagram post",
  ...
  },
  {
    ...
    benefits: [
      "Recognition on year-round school sponsor banners along the fence",
      "Business name on the main “Thank You” banner in school",
      "Business name included in group Instagram post",
      "Recognition in event newsletter",
    ...
    <section className="referral-band" aria-labelledby="referral-title">
      <div className="referral-text">
        ...
        <div className="referral-actions">
          <a className="btn-deck" href="assets/Moore Miles Sponsorship Deck.pdf" download>
